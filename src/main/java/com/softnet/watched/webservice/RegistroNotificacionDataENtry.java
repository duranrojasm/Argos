...
/**
 * <p>Clase Java para registroNotificacionDataENtry complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="registroNotificacionDataENtry">
 *   &lt;complexContent>
 ...
 *         &lt;element name="empresas" type="{http://notificacion.softnet.com}empresaBean" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "registroNotificacionDataENtry", propOrder = {
    "usuarioAdmin",
    "passAdmin",
    "empresas",
    "usuarios",
...
public class RegistroNotificacionDataENtry {
    ...
    public List<EmpresaBean> getEmpresas() {
        if (empresas == null) {
            empresas = new ArrayList<EmpresaBean>();
        }
